(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sot-sot-module"],{

/***/ "S4ao":
/*!***********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/pt/sot/sot.component.html ***!
  \***********************************************************************************************/
...
var routes = [
    {
        path: '',
        component: _sot_component__WEBPACK_IMPORTED_MODULE_4__["SotComponent"]
    }
];
var SotModule = /** @class */ (function () {
    function SotModule() {
    }
    SotModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _sot_component__WEBPACK_IMPORTED_MODULE_4__["SotComponent"]
            ],
            imports: [
...
/***/ "Y7KR":
/*!*******************************************************!*\
  !*** ./src/app/main/trg-team/pt/sot/sot.component.ts ***!
  \*******************************************************/
/*! exports provided: SotComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SotComponent", function() { return SotComponent; });
/* harmony import */ var _raw_loader_sot_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./sot.component.html */ "S4ao");
/* harmony import */ var _sot_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sot.component.scss */ "dx2J");
...
var SotComponent = /** @class */ (function () {
    function SotComponent(router, route, service, spinner, cdref, adminService, sharedService, delayDashboardService, localID) {
        var _this = this;
        this.router = router;
        this.route = route;
    ...
    SotComponent.prototype.ngOnInit = function () {
        this.getBattalionList();
    };
    SotComponent.prototype.getBattalionList = function () {
        var _this = this;
    ...
    SotComponent.prototype.battalionSelected = function (e) {
        var _this = this;
        this.companyList = [];
        this.company = '';
    ...
    SotComponent.prototype.companySelected = function (e) {
        var _this = this;
    ...
    SotComponent.prototype.search = function () {
    ...
    SotComponent.prototype.clearSearch = function () {
        if (this.battalion || this.company || this.serviceId) {
            this.companyList = [];
            this.company = '';
            this.battalion = '';
    ...
    SotComponent.prototype.getCadetsList = function () {
        var _this = this;
            ...
            if (res.status == "OK") {
                if (res.object) {
                    res.object.edossierPtResultFilterPayload.forEach(function (el) {
                        ...
                        var sot = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
    ...
    SotComponent.prototype.getFinalSubmissionDates = function (termId) {
        var _this = this;
    ...
    SotComponent.prototype.getSubjectRecord = function (sub, maxMarks) {
        var subject = {
    ...
    SotComponent.prototype.onlyNum = function (event) {
        var pattern = /^[0-9]*$/;
    ...
    SotComponent.prototype.patchNumbers = function (event, obj, i, j, type) {
    ...
    SotComponent.prototype.submitResult = function () {
        var _this = this;
    ...
    SotComponent.ctorParameters = function () { return [
    ...
    SotComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-sot',
            template: _raw_loader_sot_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_sot_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "dx2J":
/*!*********************************************************!*\
  !*** ./src/app/main/trg-team/pt/sot/sot.component.scss ***!
  \*********************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
