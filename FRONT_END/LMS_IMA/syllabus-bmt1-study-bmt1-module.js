(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["syllabus-bmt1-study-bmt1-module"],{

/***/ "5swu":
/*!****************************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/syllabus-bmt1/study-bmt1.module.ts ***!
  \****************************************************************************************/
/*! exports provided: SyllabusBMT1Module */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SyllabusBMT1Module", function() { return SyllabusBMT1Module; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _study_bmt1_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./study-bmt1.component */ "LK63");
...
var routes = [
    ...
    {
        path: 'add-mark',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-study-bmt1-add-study-bmt1-module */ "add-study-bmt1-add-study-bmt1-module").then(__webpack_require__.bind(null, /*! ./add-study-bmt1/add-study-bmt1.module */ "WCtw")).then(function (m) { return m.AddStudyBmt1Module; }); }
    },
    {
        path: 'view-mark',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-study-bmt1-add-study-bmt1-module */ "add-study-bmt1-add-study-bmt1-module").then(__webpack_require__.bind(null, /*! ./add-study-bmt1/add-study-bmt1.module */ "WCtw")).then(function (m) { return m.AddStudyBmt1Module; }); }
...
var SyllabusBMT1Module = /** @class */ (function () {
    function SyllabusBMT1Module() {
    }
    SyllabusBMT1Module = __decorate([
...
/***/ "Cl71":
/*!*********************************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/syllabus-bmt1/study-bmt1.component.scss ***!
  \*********************************************************************************************/
...
/***/ "LK63":
/*!*******************************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/syllabus-bmt1/study-bmt1.component.ts ***!
  \*******************************************************************************************/
...
/* harmony import */ var _raw_loader_study_bmt1_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./study-bmt1.component.html */ "MdZp");
/* harmony import */ var _study_bmt1_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./study-bmt1.component.scss */ "Cl71");
...
var StudyBMT1Component = /** @class */ (function () {
    function StudyBMT1Component(router, route, adminservice, trgTeamService, spinner, cdref, dialog, sharedService) {
        ...
        this.awardeesList = [];
        this.displayedColumns = ['number', 'name', 'createdAt', 'description', /*'term',*/ 'document', 'status', 'action'];
        this.Syllabus = [];
    ...
    StudyBMT1Component.prototype.getSyllabus = function (syllabusType, term, status) {
        var _this = this;
        this.spinner.show();
        this.trgTeamService.getSyllabusList(syllabusType, term, status).subscribe(function (res) {
            console.log(res);
            if (res.status == "OK") {
                _this.Syllabus = res.object;
    ...
    StudyBMT1Component.prototype.addSyllabus = function () {
    ...
    StudyBMT1Component.prototype.viewSyllabus = function (id) {
        if (this.router.url.includes('main/trg-team'))
    ...
    StudyBMT1Component.prototype.sortData = function (sort) {
        var _this = this;
        var datalist = this.Syllabus.slice();
        if (!sort.active || sort.direction === '') {
            this.Syllabus = datalist;
            return;
        }
        this.Syllabus = datalist.sort(function (a, b) {
        ...
        this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](this.Syllabus);
    ...
    StudyBMT1Component.prototype.changeStatus = function (e, d) {
        ...
        this.spinner.show();
        if (e.checked) {
            this.trgTeamService.updateSyllabusStatus(d.id, 1).subscribe(function (res) {
                console.log(res);
                if (res.status == 'OK') {
                    _this.sharedService.openSnackbar(res.message);
                    _this.cdref.detectChanges();
            ...
            this.trgTeamService.updateSyllabusStatus(d.id, 0).subscribe(function (res) {
                console.log(res);
                if (res.status == 'OK') {
                    _this.sharedService.openSnackbar(res.message);
                    _this.cdref.detectChanges();
...
/***/ "MdZp":
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/gso-two-pgme/syllabus/syllabus-bmt1/study-bmt1.component.html ***!
  \***********************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
