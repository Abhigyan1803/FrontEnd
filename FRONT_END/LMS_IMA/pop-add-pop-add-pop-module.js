(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pop-add-pop-add-pop-module"],{

/***/ "2568":
/*!*************************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/adjutant-gi/pop/add-pop/add-pop.component.scss ***!
  \*************************************************************************************/
...
/***/ "GXox":
/*!********************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/adjutant-gi/pop/add-pop/add-pop.module.ts ***!
  \********************************************************************************/
/*! exports provided: AddPopModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPopModule", function() { return AddPopModule; });
...
/* harmony import */ var _add_pop_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-pop.component */ "bd/5");
...
var routes = [
    {
        path: '',
        component: _add_pop_component__WEBPACK_IMPORTED_MODULE_8__["AddPopComponent"]
    }
];
var AddPopModule = /** @class */ (function () {
    function AddPopModule() {
    }
    AddPopModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_pop_component__WEBPACK_IMPORTED_MODULE_8__["AddPopComponent"],
            ],
            imports: [
...
/***/ "bd/5":
/*!***********************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/adjutant-gi/pop/add-pop/add-pop.component.ts ***!
  \***********************************************************************************/
/*! exports provided: AddPopComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPopComponent", function() { return AddPopComponent; });
/* harmony import */ var _raw_loader_add_pop_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-pop.component.html */ "uvHg");
/* harmony import */ var _add_pop_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-pop.component.scss */ "2568");
...
var AddPopComponent = /** @class */ (function () {
    function AddPopComponent(dialog, spinner, route, fb, router, adminservice, cdref, service, activeRoute) {
        this.dialog = dialog;
    ...
    AddPopComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (this.router.url.includes('add-pop')) {
            ...
            this.service.getPOPId(this.id).subscribe(function (res) {
                console.log(res);
                if (res.status == 'OK') {
    ...
    Object.defineProperty(AddPopComponent.prototype, "f", {
        get: function () {
    ...
    AddPopComponent.prototype.addDemoCoy = function () {
        ...
        if (this.addAcademyParadeStateForm.invalid || !this.isDoc) {
            ...
            this.spinner.show();
            this.service.addPOP(this.addAcademyParadeStateForm.value).subscribe(function (res) {
                console.log(res);
                if (res.status == 'OK') {
                    _this.service.openSnackbar(res.msg);
                    _this.cdref.detectChanges();
                    _this.spinner.hide();
                    _this.router.navigate(['main/adjutant-branch/general-instruction/pop']);
                }
                else {
                    _this.spinner.hide();
                    _this.service.openSnackbar(res.msg);
    ...
    AddPopComponent.prototype.charCount = function (e) {
        this.descLength = e.target.value.length;
    };
    AddPopComponent.prototype.openDoc = function (l) {
    ...
    AddPopComponent.prototype.onSelectDoc = function (e) {
    ...
    AddPopComponent.prototype.updateDemoCoy = function () {
        var _this = this;
        this.spinner.show();
        // console.log("Bdo", this.addBdoForm.value);
        if (this.addAcademyParadeStateForm.valid) {
            this.service.updatePOP(this.addAcademyParadeStateForm.value, this.id).subscribe(function (res) {
                // console.log(res);
                _this.apiRes(res);
            }, function (err) {
                _this.spinner.hide();
    ...
    AddPopComponent.prototype.apiRes = function (res) {
        if (res.status == 'OK') {
            this.spinner.hide();
    ...
    AddPopComponent.ctorParameters = function () { return [
    ...
    AddPopComponent.propDecorators = {
        docFile: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"], args: ['inputFile', { static: true },] }]
    };
    AddPopComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-pop',
            template: _raw_loader_add_pop_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_pop_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "uvHg":
/*!***************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/adjutant-branch/adjutant-gi/pop/add-pop/add-pop.component.html ***!
  \***************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
