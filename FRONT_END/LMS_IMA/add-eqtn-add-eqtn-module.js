(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-eqtn-add-eqtn-module"],{

/***/ "+B+w":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/eqtn/add-eqtn/add-eqtn.component.html ***!
  \***********************************************************************************************************/
...
/***/ "TGLj":
/*!****************************************************************!*\
  !*** ./src/app/main/trg-team/eqtn/add-eqtn/add-eqtn.module.ts ***!
  \****************************************************************/
/*! exports provided: AddEqtnModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddEqtnModule", function() { return AddEqtnModule; });
...
/* harmony import */ var _add_eqtn_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-eqtn.component */ "s/9X");
...
var routes = [
    {
        path: '',
        component: _add_eqtn_component__WEBPACK_IMPORTED_MODULE_8__["AddEqtnComponent"]
    }
];
var AddEqtnModule = /** @class */ (function () {
    function AddEqtnModule() {
    }
    AddEqtnModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_eqtn_component__WEBPACK_IMPORTED_MODULE_8__["AddEqtnComponent"],
            ],
            imports: [
...
/***/ "s/9X":
/*!*******************************************************************!*\
  !*** ./src/app/main/trg-team/eqtn/add-eqtn/add-eqtn.component.ts ***!
  \*******************************************************************/
/*! exports provided: AddEqtnComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddEqtnComponent", function() { return AddEqtnComponent; });
/* harmony import */ var _raw_loader_add_eqtn_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-eqtn.component.html */ "+B+w");
/* harmony import */ var _add_eqtn_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-eqtn.component.scss */ "82Ks");
...
var AddEqtnComponent = /** @class */ (function () {
    function AddEqtnComponent(dialog, 
    // private spinner: NgxSpinnerService,
    route, fb, router, adminservice, sharedservice, cdref, activeRoute, TrgTeamService) {
        this.dialog = dialog;
        this.route = route;
        this.fb = fb;
        this.router = router;
    ...
    Object.defineProperty(AddEqtnComponent.prototype, "getCSubjectRes", {
        get: function () {
    ...
    Object.defineProperty(AddEqtnComponent.prototype, "getCSubjectRes1", {
        get: function () {
            return this.eqtnForm.get('trgEQTNSubResult');
        },
        enumerable: false,
    ...
    AddEqtnComponent.prototype.genSubRec = function () {
    ...
    AddEqtnComponent.prototype.genSubRec1 = function () {
        return this.fb.group({
            // id: [''],
            // drillType:[''],
    ...
    AddEqtnComponent.prototype.ngOnInit = function () {
        var _this = this;
        // this.spinner.show();
        ...
        if (this.router.url.includes('add-eqtn')) {
            ...
            this.TrgTeamService.getEqtn(serviceId, termId).subscribe(function (res) {
                if (res.message == "update") {
                    ...
                    var cmrks = res.object.trgEQTNSubResult;
                    ...
                    _this.eqtnForm.value.trgEQTNSubResult = [];
                    _this.mnc = "add";
                    // this.isShown = true
                    _this.Campmarks = res.object;
    ...
    AddEqtnComponent.prototype.changenew = function (e) {
        var _this = this;
        var frmArray = this.eqtnForm.get('trgEQTNSubResult');
        frmArray.clear();
        ...
        this.adminservice.getSubjectMarks_List(this.serviceId, this.termId, e).subscribe(function (res) {
            if (res.message == "update") {
                ...
                _this.obtainedmarks = res.object.trgEQTNSubResult;
                ...
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object.trgEQTNSubResult);
                _this.eqtnForm.patchValue({
                    remarks: res.object.remarks,
                ...
                _this.mnc = "add";
                _this.Campmarks = res.object;
                _this.eqtnForm.controls['subject'].setValue('');
                _this.eqtnForm.controls['gcAppt'].setValue('');
                _this.eqtnForm.controls['remarks'].setValue('');
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object);
                _this.cdref.detectChanges();
            }
        }, function (err) {
    ...
    AddEqtnComponent.prototype.ngAfterViewInit = function () {
    };
    AddEqtnComponent.prototype.getTotal = function () {
        return this.Campmarks.map(function (t) { return t.totalMarks; }).reduce(function (acc, value) { return acc + value; }, 0);
    };
    AddEqtnComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\-\ ]/;
    ...
    AddEqtnComponent.prototype.viewCamp = function (element) {
    ...
    AddEqtnComponent.prototype.onChange = function (value, totalMarks, index) {
    ...
    AddEqtnComponent.prototype.onFocusEvent = function (value1) {
    ...
    AddEqtnComponent.prototype.getMarks = function (i, e) {
    ...
    AddEqtnComponent.prototype.attemptChange = function (e) {
        this.attemptvalue = e;
    };
    AddEqtnComponent.prototype.submit = function () {
        var _this = this;
        if (this.eqtnForm.invalid) {
            ...
            for (var i = 0; i < formdata.trgEQTNSubResult.length; i++) {
                delete formdata.trgEQTNSubResult[i].subjectName;
            }
            console.log(formdata, "finalresult");
            this.TrgTeamService.addEqtn(formdata).subscribe(function (res) {
                if (res.message == 'OK') {
                    _this.adminservice.openSnackbar("Eqtn Added Successfully");
                    // this.spinner.hide()
                }
                (function (err) {
                    // this.spinner.hide()
    ...
    AddEqtnComponent.prototype.confirm = function () {
        var _this = this;
        var indexT = 0;
        ...
        this.TrgTeamService.updateEqtn(formdata).subscribe(function (res) {
            if (res.message == 'OK') {
                _this.adminservice.openSnackbar("update Marks Updated Successfully");
            }
            else {
                (function (err) {
                    // this.spinner.hide()
    ...
    AddEqtnComponent.ctorParameters = function () { return [
    ...
    AddEqtnComponent.propDecorators = {
    ...
    AddEqtnComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-eqtn',
            template: _raw_loader_add_eqtn_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_eqtn_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
        __metadata("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"], app_service_trg_team_trg_team_service__WEBPACK_IMPORTED_MODULE_11__["TrgTeamService"]])
    ], AddEqtnComponent);
    return AddEqtnComponent;
}());
