(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["complaint-requirement-add-complaints-add-complaints-module"],{

/***/ "FLWA":
/*!*******************************************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/complaint-requirement/add-complaints/add-complaints.component.ts ***!
  \*******************************************************************************************************/
...
/* harmony import */ var _raw_loader_add_complaints_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-complaints.component.html */ "u9Hx");
/* harmony import */ var _add_complaints_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-complaints.component.scss */ "pX3l");
        ...
        if (this.addComplaintsForm.invalid) {
            ...
            this.adminservice.addComplaints(this.addComplaintsForm.value).subscribe(function (res) {
                ...
                if (res.status == 'OK') {
                    ...
                    _this.spinner.hide();
                    _this.router.navigate(['main/adjutant-branch/it']);
                }
                else {
                    _this.spinner.hide();
                    _this.adminservice.openSnackbar(res.message);
...
/***/ "P374":
/*!****************************************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/complaint-requirement/add-complaints/add-complaints.module.ts ***!
  \****************************************************************************************************/
...
/* harmony import */ var _add_complaints_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-complaints.component */ "FLWA");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "POLq":
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/complaint-requirement/add-complaints/add-complaints.component.html ***!
  \***********************************************************************************************************************************************/
...
/***/ "ijEC":
/*!****************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/complaint-requirement/add-complaints/add-complaints.module.ts ***!
  \****************************************************************************************************/
/*! exports provided: AddComplaintsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material/icon */ "NFeN");
/* harmony import */ var _angular_material_paginator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material/paginator */ "M9IT");
/* harmony import */ var _add_complaints_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-complaints.component */ "ztWX");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "pX3l":
/*!*********************************************************************************************************!*\
  !*** ./src/app/main/adjutant-branch/complaint-requirement/add-complaints/add-complaints.component.scss ***!
  \*********************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "u9Hx":
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/adjutant-branch/complaint-requirement/add-complaints/add-complaints.component.html ***!
  \***********************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n<div class=\"mat-new\">\r\n    <h4 class=\"card-heading\">\r\n      <button mat-icon-button (click)=\"goBack()\" ><mat-icon>chevron_left</mat-icon> </button>\r\n     Adjutant Branch<span class=\"sub-menu1\"> > Complaints <span class=\"sub-menu1\"> > {{pageTitle}}</span></span>\r\n    </h4>\r\n  </div>\r\n  <mat-card>\r\n    <div class=\"top-br\">\r\n      <form [formGroup]=\"addComplaintsForm\">\r\n  \r\n        <div class=\"row\">\r\n\r\n            <div class=\"form-group col-md-6\">\r\n               <label for=\"position\">Title<span class=\"required\">*</span></label>\r\n               <input id=\"title\" type=\"text\" class=\"form-control\" maxlength=\"100\" formControlName=\"title\"\r\n               placeholder=\"Title\">\r\n                <span class=\"validation_msg\"\r\n                    *ngIf=\"f.title.errors && f.title.errors.required && isError\">Please Enter title</span>\r\n            </div>\r\n\r\n            <div class=\"form-group col-md-6\">\r\n              <label for=\"position\">Address<span class=\"required\">*</span></label>\r\n              <input id=\"title\" type=\"text\" class=\"form-control\" maxlength=\"100\" formControlName=\"address\"\r\n              placeholder=\"address\">\r\n               <span class=\"validation_msg\"\r\n                   *ngIf=\"f.address.errors && f.address.errors.required && isError\">Please Enter Address</span>\r\n           </div>\r\n\r\n        </div> \r\n\r\n        <div class=\"row\">\r\n            <div class=\"form-group col-md-6\">\r\n                <label for=\"requestType\">Request Type<span class=\"required\" >*</span></label>\r\n                <select name=\"\" id=\"\" class=\"form-control \" formControlName=\"requestType\">\r\n                  <option value=\"\" disabled selected hidden>Request Type</option>\r\n                  <option value=\"Requirement\">Requirement </option>\r\n                  <option value=\"Complaint\">Complaint</option>\r\n                </select>\r\n                <span class=\"validation_msg\" *ngIf=\"f.requestType.errors && f.requestType.errors.required && isError\" >Request Type is required</span> \r\n              </div>\r\n\r\n              <div class=\"form-group col-md-6\">\r\n                <label for=\"requestNature\">Nature of Request<span class=\"required\" >*</span></label>\r\n                <select name=\"\" id=\"\" class=\"form-control \" formControlName=\"requestNature\">\r\n                  <option value=\"\" disabled selected hidden>Request Nature</option>\r\n                  <option value=\"IT\">IT</option>\r\n                  <option value=\"Communication\">Communication</option>\r\n                </select>\r\n                <span class=\"validation_msg\" *ngIf=\"f.requestNature.errors && f.requestNature.errors.required && isError\" >Request Nature is required</span> \r\n              </div>\r\n       </div> \r\n\r\n       \r\n\r\n        <div class=\"row\">\r\n                 <div class=\"form-group col-md-12\">\r\n            <label for=\"details\">Details <span class=\"char-count\" >   ({{descLength}}/1500)  </span> <span class=\"required\">*</span></label>\r\n            <!-- <input type=\"text\" id=\"awards\" class=\"form-control\"  maxlength=\"100\" formControlName=\"awards\" placeholder=\"Awards\"> -->\r\n            <textarea matInput placeholder=\"Maximum 1500 Characters\" class=\"form-control\"  (input)=\"charCount($event,'desc')\" maxlength=\"1500\" formControlName=\"details\"></textarea>\r\n            <span class=\"validation_msg\" *ngIf=\"f.details.errors && f.details.errors.required && isError\" >*Please Enter Details</span>\r\n\r\n             </div>\r\n        </div> \r\n\r\n        <div class=\"form-group\">\r\n          <label class=\"form-label\">File</label>\r\n            <input type=\"file\" #inputFile accept=\".pdf,.doc,.docx\" (change)=\"onSelectDoc($event)\" id=\"image\">\r\n            <mat-icon *ngIf=\"docUrl\" class=\"document_icon\" (click)=\"openDoc(docUrl)\" >description</mat-icon>\r\n            <span class=\"note\">Max File Size 50 MB. (Only pdf and doc format.)</span>\r\n        </div>\r\n\r\n        <div class=\"row\"  *ngIf=\"id\" [readonly]=\"true\">\r\n          <div class=\"form-group col-md-6\">\r\n            <label for=\"requestStatus\">Request Status</label>\r\n            <select name=\"\" id=\"\" class=\"form-control \" disabled formControlName=\"requestStatus\">\r\n              <option value=\"\" disabled selected hidden>Request status</option>\r\n              <option value=\"Pending\">Pending</option>\r\n              <option value=\"Completed\">Completed/Resolved</option>\r\n              <option value=\"Rejected\">Rejected</option>\r\n            </select>\r\n          </div>\r\n        </div>\r\n  \r\n        <div class=\"row\" *ngIf=\"id\">\r\n            <div class=\"form-group col-md-12\">\r\n            <label for=\"remarks\">Remarks by GS Branch</label>\r\n            <textarea matInput disabled placeholder=\"Maximum 500 Characters\" class=\"form-control\"  (input)=\"charCount($event,'remarks')\" maxlength=\"1500\" formControlName=\"remarks\"></textarea>\r\n                <span class=\"validation_msg\"\r\n                    *ngIf=\"f.remarks.errors && f.remarks.errors.required && isError\">Please Enter title</span>\r\n            </div>\r\n        </div> \r\n  \r\n   \r\n  \r\n        <button mat-raised-button *ngIf=\"!id\" (click)=\"addComplaints()\">ADD Complaints</button>\r\n        <button mat-raised-button *ngIf=\"id\" (click)=\"updateComplaints()\">Update Complaints</button>\r\n  \r\n      </form>\r\n    </div>\r\n  </mat-card>");

/***/ }),

/***/ "ztWX":
/*!*******************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/complaint-requirement/add-complaints/add-complaints.component.ts ***!
  \*******************************************************************************************************/
/*! exports provided: AddComplaintsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddComplaintsComponent", function() { return AddComplaintsComponent; });
/* harmony import */ var _raw_loader_add_complaints_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-complaints.component.html */ "POLq");
/* harmony import */ var _add_complaints_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-complaints.component.scss */ "TZE+");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material/dialog */ "0IaG");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "tyNb");
        ...
        if (this.addComplaintsForm.invalid) {
            ...
            this.adminservice.addComplaints(this.addComplaintsForm.value).subscribe(function (res) {
                ...
                if (res.status == 'OK') {
                    ...
                    _this.cdref.detectChanges();
                    _this.spinner.hide();
                    _this.router.navigate(['main/academic-depart/it']);
                }
                else {
                    _this.spinner.hide();
                    _this.adminservice.openSnackbar(res.message);
