(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-pcht-add-pcht-module"],{

/***/ "3peG":
/*!***********************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/pcht/add-pcht/add-pcht.module.ts ***!
  \***********************************************************************************/
/*! exports provided: AddPchtModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPchtModule", function() { return AddPchtModule; });
...
/* harmony import */ var _add_pcht_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-pcht.component */ "Hxvh");
...
var routes = [
    {
        path: '',
        component: _add_pcht_component__WEBPACK_IMPORTED_MODULE_8__["AddPchtComponent"]
    }
];
var AddPchtModule = /** @class */ (function () {
    function AddPchtModule() {
    }
    AddPchtModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_pcht_component__WEBPACK_IMPORTED_MODULE_8__["AddPchtComponent"],
            ],
            imports: [
...
/***/ "Hxvh":
/*!**************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/pcht/add-pcht/add-pcht.component.ts ***!
  \**************************************************************************************/
/*! exports provided: AddPchtComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPchtComponent", function() { return AddPchtComponent; });
/* harmony import */ var _raw_loader_add_pcht_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-pcht.component.html */ "anI9");
/* harmony import */ var _add_pcht_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-pcht.component.scss */ "xSwZ");
...
var AddPchtComponent = /** @class */ (function () {
    function AddPchtComponent(dialog, spinner, route, fb, router, adminservice, cdref, activeRoute) {
        this.dialog = dialog;
    ...
    AddPchtComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    Object.defineProperty(AddPchtComponent.prototype, "f", {
        get: function () {
    ...
    AddPchtComponent.prototype.goBack = function () {
        this.router.navigate(['main/academic-depart/examination/pcht']);
    };
    AddPchtComponent.prototype.addAchievements = function () {
        var _this = this;
        if (this.addPCHTForm.invalid || !this.isDoc) {
            ...
            this.adminservice.addPCHT(this.addPCHTForm.value).subscribe(function (res) {
                ...
                if (res.status == 'OK') {
                    ...
                    _this.spinner.hide();
                    _this.router.navigate(['main/academic-depart/examination/pcht']);
                }
                else {
                    _this.spinner.hide();
                    _this.adminservice.openSnackbar(res.message);
    ...
    AddPchtComponent.prototype.charCount = function (e) {
        this.descLength = e.target.value.length;
    };
    AddPchtComponent.prototype.openDoc = function (l) {
        console.log("++++++++", l);
    ...
    AddPchtComponent.prototype.onSelectDoc = function (e) {
    ...
    AddPchtComponent.prototype.updateAchievements = function () {
        var _this = this;
        this.spinner.show();
    ...
    AddPchtComponent.prototype.apiRes = function (res) {
        if (res.status == 'OK') {
            this.spinner.hide();
    ...
    AddPchtComponent.ctorParameters = function () { return [
    ...
    AddPchtComponent.propDecorators = {
        docFile: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"], args: ['inputFile', { static: true },] }]
    };
    AddPchtComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-pcht',
            template: _raw_loader_add_pcht_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_pcht_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "anI9":
/*!******************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/examination/pcht/add-pcht/add-pcht.component.html ***!
  \******************************************************************************************************************************/
...
/***/ "xSwZ":
/*!****************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/pcht/add-pcht/add-pcht.component.scss ***!
  \****************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
