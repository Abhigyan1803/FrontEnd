(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bpet-bpet-module"],{

/***/ "/i0S":
/*!******************************************************!*\
  !*** ./src/app/main/trg-team/pt/bpet/bpet.module.ts ***!
  \******************************************************/
/*! exports provided: BpetModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BpetModule", function() { return BpetModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _bpet_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bpet.component */ "BBkU");
...
var routes = [
    {
        path: '',
        component: _bpet_component__WEBPACK_IMPORTED_MODULE_4__["BpetComponent"]
    }
];
var BpetModule = /** @class */ (function () {
    function BpetModule() {
    }
    BpetModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _bpet_component__WEBPACK_IMPORTED_MODULE_4__["BpetComponent"]
            ],
            imports: [
...
/***/ "BBkU":
/*!*********************************************************!*\
  !*** ./src/app/main/trg-team/pt/bpet/bpet.component.ts ***!
  \*********************************************************/
/*! exports provided: BpetComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BpetComponent", function() { return BpetComponent; });
/* harmony import */ var _raw_loader_bpet_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./bpet.component.html */ "RRLO");
/* harmony import */ var _bpet_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bpet.component.scss */ "VRiL");
...
var BpetComponent = /** @class */ (function () {
    function BpetComponent(fb, router, route, service, spinner, cdref, adminService, sharedService, delayDashboardService, localID) {
        var _this = this;
        this.fb = fb;
        this.router = router;
        this.route = route;
        ...
        this._5km_mm = 25;
        this._60mtr_mm = 15;
        this._4mtrClimb_mm = 15;
        this._9mtr_mm = 10;
        this._9inchDitches_mm = 10;
        this.totalMM = 75;
        this.hasAccess = true;
    ...
    BpetComponent.prototype.ngOnInit = function () {
        this.getBattalionList();
    };
    BpetComponent.prototype.getBattalionList = function () {
        var _this = this;
    ...
    BpetComponent.prototype.battalionSelected = function (e) {
        var _this = this;
        this.companyList = [];
        this.company = '';
    ...
    BpetComponent.prototype.companySelected = function (e) {
        var _this = this;
    ...
    BpetComponent.prototype.search = function () {
    ...
    BpetComponent.prototype.clearSearch = function () {
        if (this.battalion || this.company || this.serviceId) {
            this.companyList = [];
            this.company = '';
            this.battalion = '';
    ...
    BpetComponent.prototype.getSubjectRecord = function (sub, maxMarks) {
        var subject = {
    ...
    BpetComponent.prototype.getCadetsList = function () {
        var _this = this;
        this.showSpinner = true;
        this.statusMsg = '';
        this.cadetList = [];
            ...
            if (res.status == "OK") {
                if (res.object) {
                    res.object.edossierPtResultFilterPayload.forEach(function (el) {
                        var subjArr;
                        var _5km = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "5 KM") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this._5km_mm));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
                        });
                        var _60mtr = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "60 MTR") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this._60mtr_mm));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
                        });
                        var _4mtrClimb = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "V/ROPE 4 MTR CLIMB") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this._4mtrClimb_mm));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
                        });
                        var _9mtr = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "H/ROPE 9 MTR") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this._9mtr_mm));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
                        });
                        var _9inchDitches = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "9' DITCH") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this._9inchDitches_mm));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
    ...
    BpetComponent.prototype.getFinalSubmissionDates = function (termId) {
        var _this = this;
    ...
    BpetComponent.prototype.onlyNum = function (event) {
        var pattern = /^[0-9]*$/;
    ...
    BpetComponent.prototype.patchNumbers = function (event, obj, i, j, type) {
    ...
    BpetComponent.prototype.calculateMarks = function (i) {
        var ptTotal = 0;
    ...
    BpetComponent.prototype.submitResult = function () {
        var _this = this;
    ...
    BpetComponent.ctorParameters = function () { return [
    ...
    BpetComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-bpet',
            template: _raw_loader_bpet_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_bpet_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "RRLO":
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/pt/bpet/bpet.component.html ***!
  \*************************************************************************************************/
