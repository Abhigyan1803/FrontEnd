(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sops-sops-module"],{

/***/ "S/Xl":
/*!*******************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/sops/sops.component.ts ***!
  \*******************************************************************/
...
/* harmony import */ var _raw_loader_sops_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./sops.component.html */ "ao09");
/* harmony import */ var _sops_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sops.component.scss */ "SqHX");
...
var SopsComponent = /** @class */ (function () {
    function SopsComponent(router, adminservice, spinner, cdref, dialog, sharedService) {
        this.router = router;
        ...
        this.displayedColumns = ['number', 'name', 'createdAt', 'document', 'status', 'delete', 'action'];
        this.PCHT = [];
    }
    ...
    SopsComponent.prototype.getAchievements = function (ACDCLUBS, SOPs) {
        var _this = this;
        this.spinner.show();
        this.adminservice.getClubs(ACDCLUBS, SOPs, 2).subscribe(function (res) {
            console.log(res);
            if (res.status == "OK") {
    ...
    SopsComponent.prototype.addDay = function () {
    ...
    SopsComponent.prototype.noImg = function (e) {
    ...
    SopsComponent.prototype.viewGC = function (element) {
        this.router.navigate(['main/academic-depart/clubs/sops/view-sop'], { queryParams: { id: element.id } });
    };
    SopsComponent.prototype.openDoc = function (e) {
    ...
    SopsComponent.prototype.changeGCStatus = function (e, d) {
        var _this = this;
        this.spinner.show();
        if (e.checked) {
    ...
    SopsComponent.prototype.delete = function (element) {
        var _this = this;
        this.adminservice.updateClubsStatus(element.id, 3).subscribe(function (res) {
            console.log(res);
            if (res.status == 'OK') {
                ...
                _this.cdref.detectChanges();
                _this.spinner.hide();
                _this.router.navigate(['main/academic-depart/clubs/sops']);
            }
            else {
                _this.spinner.hide();
                _this.adminservice.openSnackbar(res.message);
...
/***/ "SqHX":
/*!*********************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/sops/sops.component.scss ***!
  \*********************************************************************/
...
/***/ "TtB7":
/*!****************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/sops/sops.module.ts ***!
  \****************************************************************/
...
/* harmony import */ var _sops_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sops.component */ "S/Xl");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _sops_component__WEBPACK_IMPORTED_MODULE_5__["SopsComponent"]
    },
    {
        path: 'add-sop',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-sops-add-sops-module */ "add-sops-add-sops-module").then(__webpack_require__.bind(null, /*! ./add-sops/add-sops.module */ "AiAN")).then(function (m) { return m.AddSopsModule; }); }
    },
    {
        path: 'view-sop',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-sops-add-sops-module */ "add-sops-add-sops-module").then(__webpack_require__.bind(null, /*! ./add-sops/add-sops.module */ "AiAN")).then(function (m) { return m.AddSopsModule; }); }
...
var SopsModule = /** @class */ (function () {
    ...
    SopsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _sops_component__WEBPACK_IMPORTED_MODULE_5__["SopsComponent"],
            ],
            imports: [
...
/***/ "ao09":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/clubs/sops/sops.component.html ***!
  \***********************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
