(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["scholarly-scholarly-module"],{

/***/ "2GUZ":
/*!****************************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/scholarly/scholarly.component.scss ***!
  \****************************************************************************************/
...
/***/ "2oBj":
/*!***********************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/scholarly/scholarly.module.ts ***!
  \***********************************************************************************/
/*! exports provided: ScholarlyModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScholarlyModule", function() { return ScholarlyModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _scholarly_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scholarly.component */ "JjY4");
...
var routes = [
    {
        path: '',
        component: _scholarly_component__WEBPACK_IMPORTED_MODULE_4__["ScholarlyComponent"]
    },
    { path: 'add-syllabus', loadChildren: function () { return __webpack_require__.e(/*! import() | add-syllabus-add-syllabus-module */ "add-syllabus-add-syllabus-module").then(__webpack_require__.bind(null, /*! ./add-syllabus/add-syllabus.module */ "TNK7")).then(function (m) { return m.AddSyllabusModule; }); } },
    { path: 'view-syllabus', loadChildren: function () { return __webpack_require__.e(/*! import() | add-syllabus-add-syllabus-module */ "add-syllabus-add-syllabus-module").then(__webpack_require__.bind(null, /*! ./add-syllabus/add-syllabus.module */ "TNK7")).then(function (m) { return m.AddSyllabusModule; }); } },
];
var ScholarlyModule = /** @class */ (function () {
    function ScholarlyModule() {
    }
    ScholarlyModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _scholarly_component__WEBPACK_IMPORTED_MODULE_4__["ScholarlyComponent"]
            ],
            imports: [
...
/***/ "JjY4":
/*!**************************************************************************************!*\
  !*** ./src/app/main/trg-team/gso-two-pgme/syllabus/scholarly/scholarly.component.ts ***!
  \**************************************************************************************/
/*! exports provided: ScholarlyComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScholarlyComponent", function() { return ScholarlyComponent; });
/* harmony import */ var _raw_loader_scholarly_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./scholarly.component.html */ "esiH");
/* harmony import */ var _scholarly_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scholarly.component.scss */ "2GUZ");
...
var ScholarlyComponent = /** @class */ (function () {
    function ScholarlyComponent(spinner, cdref, dialog, sharedService, router, route, service) {
        var _this = this;
    ...
    ScholarlyComponent.prototype.ngOnInit = function () {
    };
    ScholarlyComponent.prototype.ngAfterViewInit = function () {
        this.getSyllabusList();
    };
    ScholarlyComponent.prototype.getSyllabusList = function () {
        var _this = this;
        this.spinner.show();
        this.service.getSyllabusList('Scholarly', this.termId, 2).subscribe(function (res) {
            if (res.status == "OK") {
    ...
    ScholarlyComponent.prototype.addSyllabus = function () {
    ...
    ScholarlyComponent.prototype.viewSyllabus = function (s) {
        if (this.router.url.includes('/main/admin/trg-team/')) {
    ...
    ScholarlyComponent.prototype.openDoc = function (d) {
    ...
    ScholarlyComponent.prototype.changeStatus = function (e, l) {
        var _this = this;
        this.spinner.show();
        if (e.checked) {
    ...
    ScholarlyComponent.prototype.applyFilter = function (event) {
    ...
    ScholarlyComponent.prototype.sortData = function (sort) {
        var _this = this;
    ...
    ScholarlyComponent.ctorParameters = function () { return [
    ...
    ScholarlyComponent.propDecorators = {
    ...
    ScholarlyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-scholarly',
            template: _raw_loader_scholarly_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_scholarly_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "esiH":
/*!******************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/gso-two-pgme/syllabus/scholarly/scholarly.component.html ***!
  \******************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
