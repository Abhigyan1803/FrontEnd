(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-credit-exellence-add-credit-exellence-module"],{

/***/ "4Dr2":
/*!***************************************************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/credit-exellence/add-credit-exellence/add-credit-exellence.component.scss ***!
  \***************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (".row.ima_clas {\n  border-bottom: 1px solid #ccc;\n  margin-bottom: 12px;\n  background: #eee;\n  margin-top: -12px;\n  padding-top: 10px;\n}\n\n.common_cls button {\n  margin: 0px 10px;\n  padding: 0px 12px;\n  width: 100px;\n}\n\n.common_cls {\n  display: flex;\n}\n\n.next-button {\n  float: right;\n}\n\nspan.not_cls {\n  font-size: 12px;\n  color: #333;\n  font-weight: 600;\n}\n\nspan.col-md-12.not_msg {\n  font-weight: 600;\n  color: #afabab !important;\n  margin-bottom: 9px;\n  font-size: 13px;\n  letter-spacing: 0.3px;\n}\n\n.remarkdiv {\n  flex: 9%;\n}\n\n.remarkheight {\n  float: right;\n  height: 20%;\n}\n\n.submitbutton {\n  float: right;\n  margin: 10px 0px;\n  padding: 0;\n}\n\n.submitbutton button.mat-focus-indicator.mat-raised-button.mat-button-base {\n  background: #721a0c;\n  color: #fff;\n  font-size: 15px;\n  float: right;\n}\n\ntextarea.form-control.textarea-33.ng-pristine.ng-valid.ng-touched {\n  box-shadow: 2px 2px 2px #ccc;\n}\n\n.form-group.col-md-12.remarkdiv {\n  margin-top: 15px;\n}\n\n.example-container.ng-star-inserted {\n  width: 100%;\n  border: 1px solid #ccc;\n  padding: 15px 0px;\n  box-shadow: 2px 2px 5px 2px #ccc;\n  background: #fafafa;\n}\n\n.form-group.col-md-12.remarkdiv {\n  padding: 0px;\n}\n\ntable {\n  border: 1px solid #ccc;\n}\n\n.row1.row234 {\n  border: 1px solid #ccc;\n  padding: 15px 0px;\n  box-shadow: 2px 2px 5px 2px #ccc;\n  background: #fafafa;\n}");

/***/ }),

/***/ "Njlw":
/*!*************************************************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/credit-exellence/add-credit-exellence/add-credit-exellence.component.ts ***!
  \*************************************************************************************************************************************/
/*! exports provided: AddCreditExellenceComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddCreditExellenceComponent", function() { return AddCreditExellenceComponent; });
/* harmony import */ var _raw_loader_add_credit_exellence_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-credit-exellence.component.html */ "mLZD");
/* harmony import */ var _add_credit_exellence_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-credit-exellence.component.scss */ "4Dr2");
...
var AddCreditExellenceComponent = /** @class */ (function () {
    function AddCreditExellenceComponent(dialog, spinner, route, fb, router, adminservice, sharedservice, cdref, academicservice, activeRoute) {
        this.dialog = dialog;
    ...
    Object.defineProperty(AddCreditExellenceComponent.prototype, "getCSubjectRes", {
        get: function () {
            return this.creditForm.get('creditExcellenceSubResult');
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AddCreditExellenceComponent.prototype, "getCSubjectRes1", {
        get: function () {
            return this.creditForm.get('creditExcellenceSubResult');
        },
        enumerable: false,
    ...
    AddCreditExellenceComponent.prototype.genSubRec = function () {
    ...
    AddCreditExellenceComponent.prototype.genSubRec1 = function () {
        return this.fb.group({
            // id: [''],
            // drillType:[''],
    ...
    AddCreditExellenceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinner.show();
        ...
        if (this.router.url.includes('add-credit')) {
            ...
            this.adminservice.getDrillMarks(this.id).subscribe(function (res) {
                if (res.status == 'OK') {
                    ...
                    console.log(_this.serId, "id");
                    _this.spinner.hide();
                    _this.creditForm.patchValue({
            ...
            this.academicservice.getCreditExcellence(serviceId, termId).subscribe(function (res) {
                if (res.message == "update") {
                    ...
                    _this.creditForm.value.creditExcellenceSubResult = [];
                    _this.mnc = "add";
                    // this.isShown = true
                    _this.Campmarks = res.object;
    ...
    AddCreditExellenceComponent.prototype.changenew = function (e) {
        var _this = this;
        var frmArray = this.creditForm.get('creditExcellenceSubResult');
        frmArray.clear();
        ...
        this.adminservice.getSubjectMarks_List(this.serviceId, this.termId, e).subscribe(function (res) {
            if (res.message == "update") {
                ...
                _this.obtainedmarks = res.object.creditExcellenceSubResult;
                _this.drilleditid = res.object.campMarksResultId;
                console.log(_this.drilleditid, "drilleditid");
                var cmrks = res.object.creditExcellenceSubResult;
                cmrks.forEach(function (e) {
                ...
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object.creditExcellenceSubResult);
                _this.creditForm.patchValue({
                    remarks: res.object.remarks,
                ...
                _this.mnc = "add";
                _this.Campmarks = res.object;
                _this.creditForm.controls['subject'].setValue('');
                _this.creditForm.controls['gcAppt'].setValue('');
                _this.creditForm.controls['remarks'].setValue('');
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object);
                _this.cdref.detectChanges();
            }
        }, function (err) {
    ...
    AddCreditExellenceComponent.prototype.ngAfterViewInit = function () {
    };
    AddCreditExellenceComponent.prototype.getTotal = function () {
        return this.Campmarks.map(function (t) { return t.totalMarks; }).reduce(function (acc, value) { return acc + value; }, 0);
    };
    AddCreditExellenceComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\-\ ]/;
    ...
    AddCreditExellenceComponent.prototype.viewCamp = function (element) {
    ...
    AddCreditExellenceComponent.prototype.onChange = function (value, totalMarks, index) {
    ...
    AddCreditExellenceComponent.prototype.onFocusEvent = function (value1) {
    ...
    AddCreditExellenceComponent.prototype.getMarks = function (i, e) {
    ...
    AddCreditExellenceComponent.prototype.attemptChange = function (e) {
        this.attemptvalue = e;
    };
    AddCreditExellenceComponent.prototype.submit = function () {
        var _this = this;
        if (this.creditForm.invalid) {
            ...
            for (var i = 0; i < formdata.creditExcellenceSubResult.length; i++) {
                delete formdata.creditExcellenceSubResult[i].subjectName;
            }
            console.log(formdata, "finalresult");
            this.academicservice.addCreditExcellence(formdata).subscribe(function (res) {
                if (res.message == 'Record added succesfully') {
                    _this.adminservice.openSnackbar("Credit Of Exellence Added Successfully");
                    // this.spinner.hide()
                }
                (function (err) {
                    // this.spinner.hide()
    ...
    AddCreditExellenceComponent.prototype.confirm = function () {
        var _this = this;
        var indexT = 0;
        ...
        this.academicservice.updateCreditExcellence(formdata).subscribe(function (res) {
            if (res.message == 'Record updated successfully') {
                _this.adminservice.openSnackbar("Credit Of Exellence Updated Successfully");
            }
            else {
                (function (err) {
                    _this.spinner.hide();
    ...
    AddCreditExellenceComponent.ctorParameters = function () { return [
    ...
    AddCreditExellenceComponent.propDecorators = {
    ...
    AddCreditExellenceComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-credit-exellence',
            template: _raw_loader_add_credit_exellence_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_credit_exellence_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
        __metadata("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"],
            ...
            app_service_shared_service__WEBPACK_IMPORTED_MODULE_11__["SharedService"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"], app_service_academic_dept_academic_dept_service__WEBPACK_IMPORTED_MODULE_9__["AcademicDeptService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"]])
    ], AddCreditExellenceComponent);
    return AddCreditExellenceComponent;
}());
...
/***/ "hmJX":
/*!**********************************************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/credit-exellence/add-credit-exellence/add-credit-exellence.module.ts ***!
  \**********************************************************************************************************************************/
/*! exports provided: AddCreditExellenceModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddCreditExellenceModule", function() { return AddCreditExellenceModule; });
...
/* harmony import */ var _add_credit_exellence_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-credit-exellence.component */ "Njlw");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _add_credit_exellence_component__WEBPACK_IMPORTED_MODULE_8__["AddCreditExellenceComponent"]
    }
];
var AddCreditExellenceModule = /** @class */ (function () {
    function AddCreditExellenceModule() {
    }
    AddCreditExellenceModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_credit_exellence_component__WEBPACK_IMPORTED_MODULE_8__["AddCreditExellenceComponent"],
            ],
            imports: [
    ...
    ], AddCreditExellenceModule);
    return AddCreditExellenceModule;
}());
...
/***/ "mLZD":
/*!*****************************************************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/examination/assessment/credit-exellence/add-credit-exellence/add-credit-exellence.component.html ***!
  \*****************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
