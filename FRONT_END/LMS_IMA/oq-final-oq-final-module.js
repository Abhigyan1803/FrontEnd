(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["oq-final-oq-final-module"],{

/***/ "8WpQ":
/*!****************************************************************************!*\
  !*** ./src/app/main/trg-battalion/oq-marks/oq-final/oq-final.component.ts ***!
  \****************************************************************************/
/*! exports provided: OqFinalComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OqFinalComponent", function() { return OqFinalComponent; });
/* harmony import */ var _raw_loader_oq_final_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./oq-final.component.html */ "OGWV");
/* harmony import */ var _oq_final_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./oq-final.component.scss */ "HKCq");
...
var OqFinalComponent = /** @class */ (function () {
    function OqFinalComponent(dialog, modalService, spinner, route, fb, router, _trgBattalion, adminservice, cdref, activeRoute) {
        var _this = this;
        this.dialog = dialog;
    ...
    OqFinalComponent.prototype.ngOnInit = function () {
    };
    OqFinalComponent.prototype.ngAfterViewInit = function () {
    };
    OqFinalComponent.prototype.onChange1 = function (e, value, totalMarksPlCdr, sub_id, mainIndex, subIndex1) {
    ...
    OqFinalComponent.prototype.onFocusEvent1 = function (value, mainIndex) {
    ...
    OqFinalComponent.prototype.onChange2 = function (e, value2, totalMarksCoyCdr, sub_id, mainIndex2, subIndex2) {
    ...
    OqFinalComponent.prototype.onFocusEvent2 = function (value2, mainIndex2) {
    ...
    OqFinalComponent.prototype.onChange3 = function (e, value3, totalMarksBnCdr, sub_id, mainIndex3, subIndex) {
    ...
    OqFinalComponent.prototype.onFocusEvent3 = function (value3, mainIndex3) {
    ...
    OqFinalComponent.prototype.confirm = function () {
        var _this = this;
        this.spinner.show();
    ...
    OqFinalComponent.prototype.battalionSelected = function (e) {
        var _this = this;
    ...
    OqFinalComponent.prototype.companySelected = function (e) {
        this.companyName = e;
    ...
    OqFinalComponent.prototype.getSpecialAllList = function () {
        var _this = this;
        this._trgBattalion.getOQ_Final_All_ListByBCNameComp(this.termId, this.currentPage, this.pageSize, this.battalionName).subscribe(function (res) {
            console.log(res);
            if (res.message == 'OK') {
    ...
    OqFinalComponent.prototype.onChangesubmit = function (value) {
        this.value = value;
    };
    OqFinalComponent.prototype.getTotal = function (marks) {
        return marks.reduce(function (acc, _a) {
            var obtainedMarksPlCdr = _a.obtainedMarksPlCdr;
            return acc += +(obtainedMarksPlCdr || 0);
        }, 0);
    };
    OqFinalComponent.prototype.getOQMarksSubject = function () {
        var _this = this;
        this.spinner.show();
    ...
    OqFinalComponent.prototype.serviceSearch = function (e) {
        this.serviceid = e;
        if (this.serviceid == null || this.serviceid == undefined || this.serviceid == '') {
            this.getOQMarksAlllist();
        }
    };
    OqFinalComponent.prototype.edSearch = function (event) {
        var _this = this;
        if (this.serviceid == null || this.serviceid == undefined || this.serviceid == '') {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["merge"])(/* this.sort.sortChange,  */ this.paginator.page)
                ...
                _this.spinner.show();
                return _this._trgBattalion.getOQ_Final_Marks_list_search(_this.termId, _this.serviceid, _this.paginator.pageIndex, _this.paginator.pageSize);
    ...
    OqFinalComponent.prototype.pageChanged = function (event) {
    ...
    OqFinalComponent.prototype.getOQMarksAlllist = function () {
        var _this = this;
        this.spinner.show();
        if (this.battalionId == 1 || this.battalionId == 2 || this.battalionId == 3 || this.battalionId == 4) {
            this._trgBattalion.getOQ_Final_Marks_All_ListByBCName(this.termId, this.currentPage, this.pageSize, this.battalionName, this.companyName).subscribe(function (res) {
                console.log(res);
            ...
            this._trgBattalion.getOQ_final_Marks_list(this.termId, this.currentPage, this.pageSize).subscribe(function (res) {
                console.log(res);
                if (res.message == 'Record not found') {
                    _this.spinner.hide();
                    _this._trgBattalion.openSnackbar(res.message);
    ...
    OqFinalComponent.prototype.openPopup = function () {
        this.displayStyle = "block";
    };
    OqFinalComponent.prototype.closePopup = function () {
        this.displayStyle = "none";
    };
    OqFinalComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\ ]/;
    ...
    OqFinalComponent.ctorParameters = function () { return [
    ...
    OqFinalComponent.propDecorators = {
    ...
    OqFinalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-oq-final',
            template: _raw_loader_oq_final_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_oq_final_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "AA5o":
/*!***************************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/examination/assessment/oq-matrix-both/oq-final/oq-final.component.html ***!
  \***************************************************************************************************************************************************/
...
/***/ "OGWV":
/*!********************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-battalion/oq-marks/oq-final/oq-final.component.html ***!
  \********************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "fPsh":
/*!********************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/oq-matrix-both/oq-final/oq-final.module.ts ***!
  \********************************************************************************************************/
/*! exports provided: OQFinalModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OQFinalModule", function() { return OQFinalModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _oq_final_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./oq-final.component */ "vh6v");
...
var routes = [
    {
        path: '',
        component: _oq_final_component__WEBPACK_IMPORTED_MODULE_4__["OqFinalComponent"]
    },
];
var OQFinalModule = /** @class */ (function () {
    function OQFinalModule() {
    }
    OQFinalModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _oq_final_component__WEBPACK_IMPORTED_MODULE_4__["OqFinalComponent"],
            ],
            imports: [
...
/***/ "v2+9":
/*!*************************************************************************!*\
  !*** ./src/app/main/trg-battalion/oq-marks/oq-final/oq-final.module.ts ***!
  \*************************************************************************/
/*! exports provided: OqMarksFinalModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OqMarksFinalModule", function() { return OqMarksFinalModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
...
/* harmony import */ var _oq_final_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./oq-final.component */ "8WpQ");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _oq_final_component__WEBPACK_IMPORTED_MODULE_5__["OqFinalComponent"],
    },
];
var OqMarksFinalModule = /** @class */ (function () {
    function OqMarksFinalModule() {
    }
    OqMarksFinalModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _oq_final_component__WEBPACK_IMPORTED_MODULE_5__["OqFinalComponent"],
            ],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes),
...
/***/ "vh6v":
/*!***********************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/oq-matrix-both/oq-final/oq-final.component.ts ***!
  \***********************************************************************************************************/
/*! exports provided: OqFinalComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OqFinalComponent", function() { return OqFinalComponent; });
/* harmony import */ var _raw_loader_oq_final_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./oq-final.component.html */ "AA5o");
/* harmony import */ var _oq_final_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./oq-final.component.scss */ "T9jL");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material/dialog */ "0IaG");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "tyNb");
...
var OqFinalComponent = /** @class */ (function () {
    function OqFinalComponent(dialog, spinner, route, fb, router, academicservice, adminservice, cdref, activeRoute) {
        var _this = this;
        this.dialog = dialog;
        this.spinner = spinner;
        this.route = route;
    ...
    OqFinalComponent.prototype.blockPaste = function (e) {
        e.preventDefault();
    };
    OqFinalComponent.prototype.ngOnInit = function () {
    };
    OqFinalComponent.prototype.OQName = function () { };
    OqFinalComponent.prototype.clearSearch = function () {
    ...
    OqFinalComponent.prototype.allData = function () {
        var _this = this;
        this.academicservice.getOQ_Final_matrix_list(this.termId, this.currentPage, this.pageSize).subscribe(function (res) {
            console.log(res);
            if (res.message == 'Record not found') {
                _this.spinner.hide();
    ...
    OqFinalComponent.prototype.getSpecialAllList = function () {
        var _this = this;
        this.academicservice.getOQ_Final_All_ListByBCNameComp(this.termId, this.currentPage, this.pageSize, this.battalionName).subscribe(function (res) {
            console.log(res);
            if (res.message == 'OK') {
                _this.resultsLength = res.object.totalRecords;
                _this.oqCadetList = res.object.oqMatrixFilterPayload;
    ...
    OqFinalComponent.prototype.onChange = function (e, value, totalMarks, sub_id, mainIndex, subIndex) {
    ...
    OqFinalComponent.prototype.onFocusEvent = function (value, mainIndex) {
        if (value == NaN || value == '' || value == undefined) {
            return false;
        }
        var total = document.getElementById(mainIndex).value;
    ...
    OqFinalComponent.prototype.getOQSubjectMatrix = function () {
        var _this = this;
        this.spinner.show();
    ...
    OqFinalComponent.prototype.edSearch = function (event) {
        ...
        if (this.serviceid == null || this.serviceid == undefined || this.serviceid == '') {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["merge"])(/* this.sort.sortChange,  */ this.paginator.page)
                ...
                _this.spinner.show();
                return _this.academicservice.getOQ_Final_Matrix_search(_this.termId, _this.serviceid, _this.paginator.pageIndex, _this.paginator.pageSize);
    ...
    OqFinalComponent.prototype.getOQAllCadetlist = function (event) {
        var _this = this;
        if (this.battalionId == 1 || this.battalionId == 2 || this.battalionId == 3 || this.battalionId == 4) {
            this.academicservice.getOQ_Final_All_ListByBCName(this.termId, this.currentPage, this.pageSize, this.battalionName, this.companyName).subscribe(function (res) {
                console.log(res);
                if (res.message == 'Record not found') {
                    _this.spinner.hide();
                    _this.academicservice.openSnackbar(res.message);
