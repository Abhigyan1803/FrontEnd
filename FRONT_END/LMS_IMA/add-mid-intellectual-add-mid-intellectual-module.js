(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-mid-intellectual-add-mid-intellectual-module"],{

/***/ "4QL3":
/*!****************************************************************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/intellectual/mid-intellectual/add-mid-intellectual/add-mid-intellectual.component.scss ***!
  \****************************************************************************************************************************************************/
...
/***/ "GJl7":
/*!***********************************************************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/examination/assessment/intellectual/mid-intellectual/add-mid-intellectual/add-mid-intellectual.module.ts ***!
  \***********************************************************************************************************************************************/
/*! exports provided: AddMidIntellectualModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddMidIntellectualModule", function() { return AddMidIntellectualModule; });
...
/* harmony import */ var _add_mid_intellectual_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-mid-intellectual.component */ "wqK8");
...
var routes = [
    {
        path: '',
        component: _add_mid_intellectual_component__WEBPACK_IMPORTED_MODULE_8__["AddMidIntellectualComponent"]
    }
];
var AddMidIntellectualModule = /** @class */ (function () {
    function AddMidIntellectualModule() {
    }
    AddMidIntellectualModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_mid_intellectual_component__WEBPACK_IMPORTED_MODULE_8__["AddMidIntellectualComponent"],
            ],
            imports: [
    ...
    ], AddMidIntellectualModule);
    return AddMidIntellectualModule;
}());
...
/***/ "NUMq":
/*!******************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/examination/assessment/intellectual/mid-intellectual/add-mid-intellectual/add-mid-intellectual.component.html ***!
  \******************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AddMidIntellectualComponent = /** @class */ (function () {
    function AddMidIntellectualComponent(dialog, spinner, route, fb, router, adminservice, sharedservice, academicservice, cdref, edossierservice, activeRoute) {
        var _this = this;
        this.dialog = dialog;
        ...
        this.termid = '';
        this.totalss = 0;
        this.intellectualMidMarkForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormGroup"]({});
    ...
    Object.defineProperty(AddMidIntellectualComponent.prototype, "getCSubjectRes", {
        get: function () {
            return this.intellectualMidMarkForm.get('intellectualSkillsSubResult');
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AddMidIntellectualComponent.prototype, "getCSubjectRes1", {
        get: function () {
            return this.intellectualMidMarkForm.get('intellectualSkillsSubResult');
        },
        enumerable: false,
    ...
    AddMidIntellectualComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinner.show();
        ...
        if (this.router.url.includes('Mid-Term/add-mid-intellectual')) {
            ...
            this.academicservice.getIntellectualskills(serviceId, termId).subscribe(function (res) {
                if (res.message == "update") {
                    ...
                    _this.updatetotalmarks = res.object.midTotalMarks;
                    _this.totalmarkst = res.object.midObtainedMarks;
                    ...
                    _this.intellectualMidMarkForm.patchValue({
                    ...
                    _this.intellectualMidMarkForm.value.intellectualSkillsSubResult = [];
                    _this.mnc = "add";
                    _this.Campmarks = res.object;
    ...
    AddMidIntellectualComponent.prototype.genSubRec = function () {
    ...
    AddMidIntellectualComponent.prototype.genSubRec1 = function () {
        return this.fb.group({
            serviceId: [this.serviceid],
            status: ['1'],
            subjectId: [''],
    ...
    AddMidIntellectualComponent.prototype.ngAfterViewInit = function () {
    };
    AddMidIntellectualComponent.prototype.getTotal = function () {
        return this.Campmarks.map(function (t) { return t.midTotalMarks; }).reduce(function (acc, value) { return acc + value; }, 0);
    };
    AddMidIntellectualComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\-\ ]/;
    ...
    AddMidIntellectualComponent.prototype.viewCamp = function (element) {
    ...
    AddMidIntellectualComponent.prototype.onChange = function (value, midTotalMarks, index) {
    ...
    AddMidIntellectualComponent.prototype.onFocusEvent = function (value1) {
    ...
    AddMidIntellectualComponent.prototype.getMarks = function (i, e) {
    ...
    AddMidIntellectualComponent.prototype.attemptChange = function (e) {
        this.attemptvalue = e;
    };
    AddMidIntellectualComponent.prototype.submit = function () {
        var _this = this;
    ...
    AddMidIntellectualComponent.prototype.confirm = function () {
        var _this = this;
        var indexT = 0;
        this.intellectualMidMarkForm.value.serviceId = this.serviceid;
    ...
    AddMidIntellectualComponent.ctorParameters = function () { return [
    ...
    AddMidIntellectualComponent.propDecorators = {
    ...
    AddMidIntellectualComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-mid-intellectual',
            template: _raw_loader_add_mid_intellectual_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_mid_intellectual_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
    ...
    return AddMidIntellectualComponent;
}());
