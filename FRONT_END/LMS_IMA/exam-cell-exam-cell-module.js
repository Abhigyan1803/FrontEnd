(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["exam-cell-exam-cell-module"],{

/***/ "Ex13":
/*!*******************************************************************************************!*\
  !*** ./src/app/main/academic-depart/General-Instruction/exam-cell/exam-cell.component.ts ***!
  \*******************************************************************************************/
/*! exports provided: ExamCellComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExamCellComponent", function() { return ExamCellComponent; });
/* harmony import */ var _raw_loader_exam_cell_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./exam-cell.component.html */ "g8TM");
/* harmony import */ var _exam_cell_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./exam-cell.component.scss */ "MMFf");
...
var ExamCellComponent = /** @class */ (function () {
    function ExamCellComponent(router, adminservice, spinner, cdref, dialog, sharedService) {
        this.router = router;
    ...
    ExamCellComponent.prototype.ngOnInit = function () {
    };
    ExamCellComponent.prototype.ngAfterViewInit = function () {
        this.getAchievements('INSTRUCTION', 'EXAM');
    };
    ExamCellComponent.prototype.getAchievements = function (INSTRUCTION, EXAM) {
        var _this = this;
        this.spinner.show();
        this.adminservice.getClubs(INSTRUCTION, EXAM, 2).subscribe(function (res) {
            console.log(res);
            if (res.status == "OK") {
    ...
    ExamCellComponent.prototype.addDay = function () {
        this.router.navigate(['/main/academic-depart/general/exam/add-exam']);
    };
    ExamCellComponent.prototype.noImg = function (e) {
        e.target.src = "assets/img/default_user.png";
    };
    ExamCellComponent.prototype.applyFilter = function (event) {
    ...
    ExamCellComponent.prototype.viewGC = function (element) {
    ...
    ExamCellComponent.prototype.sortData = function (sort) {
        var _this = this;
    ...
    ExamCellComponent.prototype.openDoc = function (e) {
    ...
    ExamCellComponent.prototype.changeGCStatus = function (e, d) {
        var _this = this;
        this.spinner.show();
        if (e.checked) {
    ...
    ExamCellComponent.ctorParameters = function () { return [
    ...
    ExamCellComponent.propDecorators = {
    ...
    ExamCellComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-exam-cell',
            template: _raw_loader_exam_cell_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_exam_cell_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "MMFf":
/*!*********************************************************************************************!*\
  !*** ./src/app/main/academic-depart/General-Instruction/exam-cell/exam-cell.component.scss ***!
  \*********************************************************************************************/
...
/***/ "V3in":
/*!****************************************************************************************!*\
  !*** ./src/app/main/academic-depart/General-Instruction/exam-cell/exam-cell.module.ts ***!
  \****************************************************************************************/
...
/* harmony import */ var _exam_cell_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./exam-cell.component */ "Ex13");
...
var routes = [
    {
        path: '',
        component: _exam_cell_component__WEBPACK_IMPORTED_MODULE_4__["ExamCellComponent"]
    },
    {
        path: 'add-exam',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-exam-add-exam-module */ "add-exam-add-exam-module").then(__webpack_require__.bind(null, /*! ./add-exam/add-exam.module */ "WhCy")).then(function (m) { return m.AddExamModule; }); }
    },
    {
        path: 'view-exam',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-exam-add-exam-module */ "add-exam-add-exam-module").then(__webpack_require__.bind(null, /*! ./add-exam/add-exam.module */ "WhCy")).then(function (m) { return m.AddExamModule; }); }
...
var ExamModule = /** @class */ (function () {
    ...
    ExamModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _exam_cell_component__WEBPACK_IMPORTED_MODULE_4__["ExamCellComponent"],
            ],
            imports: [
...
/***/ "g8TM":
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/General-Instruction/exam-cell/exam-cell.component.html ***!
  \***********************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
