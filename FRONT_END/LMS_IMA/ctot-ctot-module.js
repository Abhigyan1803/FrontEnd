(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ctot-ctot-module"],{

/***/ "/Qgb":
/*!*********************************************************!*\
  !*** ./src/app/main/trg-team/pt/ctot/ctot.component.ts ***!
  \*********************************************************/
/*! exports provided: CtotComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CtotComponent", function() { return CtotComponent; });
/* harmony import */ var _raw_loader_ctot_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./ctot.component.html */ "f8SS");
/* harmony import */ var _ctot_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ctot.component.scss */ "PLec");
...
var CtotComponent = /** @class */ (function () {
    function CtotComponent(fb, router, route, service, spinner, cdref, adminService, sharedService, delayDashboardService, localID) {
        var _this = this;
        this.fb = fb;
        this.router = router;
        this.route = route;
    ...
    CtotComponent.prototype.ngOnInit = function () {
        this.getBattalionList();
    };
    CtotComponent.prototype.getBattalionList = function () {
        var _this = this;
    ...
    CtotComponent.prototype.battalionSelected = function (e) {
        var _this = this;
    ...
    CtotComponent.prototype.companySelected = function (e) {
        var _this = this;
    ...
    CtotComponent.prototype.search = function () {
    ...
    CtotComponent.prototype.clearSearch = function () {
        if (this.battalion || this.company || this.serviceId) {
            this.companyList = [];
            this.battalion = '';
            this.company = '';
    ...
    CtotComponent.prototype.getCadetsList = function () {
        var _this = this;
            ...
            if (res.status == "OK") {
                if (res.object) {
                    res.object.edossierPtResultFilterPayload.forEach(function (el) {
                        var subjArr;
                        var handsNfootBridge = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                            if (sub.subjectName.trim() === "HAND & FOOT BRIDGE") {
                                Object.assign(sub, _this.getSubjectRecord(sub, _this.maxMarks, _this.passingMarks));
                                delete sub.createdAt;
                                delete sub.updatedAt;
                                return sub;
                            }
                        });
                        var highLadder = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                        ...
                        var circus = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                        ...
                        var tarzanHandwalk = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                        ...
                        var scrambleNet = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
                        ...
                        var imaLadder = el.edossierPtResult.edossierPtSubjectResult.find(function (sub) {
    ...
    CtotComponent.prototype.getFinalSubmissionDates = function (termId) {
        var _this = this;
    ...
    CtotComponent.prototype.getSubjectRecord = function (sub, maxMarks, passingMarks) {
        var subject = {
    ...
    CtotComponent.prototype.onlyNum = function (event) {
        var pattern = /^[0-9]*$/;
    ...
    CtotComponent.prototype.patchNumbers = function (event, obj, i, j, type) {
    ...
    CtotComponent.prototype.calculateMarks = function (i) {
        var ptTotal = 0;
    ...
    CtotComponent.prototype.submitResult = function () {
        var _this = this;
    ...
    CtotComponent.ctorParameters = function () { return [
    ...
    CtotComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-ctot',
            template: _raw_loader_ctot_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_ctot_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "EDui":
/*!******************************************************!*\
  !*** ./src/app/main/trg-team/pt/ctot/ctot.module.ts ***!
  \******************************************************/
/*! exports provided: CtotModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CtotModule", function() { return CtotModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _ctot_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ctot.component */ "/Qgb");
...
var routes = [
    {
        path: '',
        component: _ctot_component__WEBPACK_IMPORTED_MODULE_4__["CtotComponent"]
    }
];
var CtotModule = /** @class */ (function () {
    function CtotModule() {
    }
    CtotModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _ctot_component__WEBPACK_IMPORTED_MODULE_4__["CtotComponent"]
            ],
            imports: [
...
/***/ "PLec":
/*!***********************************************************!*\
  !*** ./src/app/main/trg-team/pt/ctot/ctot.component.scss ***!
  \***********************************************************/
...
/***/ "f8SS":
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/trg-team/pt/ctot/ctot.component.html ***!
  \*************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
