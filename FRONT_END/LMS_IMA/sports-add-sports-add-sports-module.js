(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sports-add-sports-add-sports-module"],{

/***/ "6o4l":
/*!********************************************************************************!*\
  !*** ./src/app/main/academic-depart/sports/add-sports/add-sports.component.ts ***!
  \********************************************************************************/
/*! exports provided: AddSportsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddSportsComponent", function() { return AddSportsComponent; });
/* harmony import */ var _raw_loader_add_sports_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-sports.component.html */ "llCw");
/* harmony import */ var _add_sports_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-sports.component.scss */ "ypAJ");
...
var AddSportsComponent = /** @class */ (function () {
    function AddSportsComponent(dialog, spinner, route, fb, router, adminservice, sharedservice, cdref, activeRoute, AcademicDeptService) {
        this.dialog = dialog;
        ...
        this.AcademicDeptService = AcademicDeptService;
        this.id = '';
        this.termid = '';
        this.termsession = '';
        this.totalss = 0;
    ...
    Object.defineProperty(AddSportsComponent.prototype, "getCSubjectRes", {
        get: function () {
    ...
    Object.defineProperty(AddSportsComponent.prototype, "getCSubjectRes1", {
        get: function () {
            return this.drillForm.get('dRILLSubjectResult');
        },
        enumerable: false,
    ...
    AddSportsComponent.prototype.genSubRec = function () {
    ...
    AddSportsComponent.prototype.genSubRec1 = function () {
        return this.fb.group({
            // id: [''],
            // drillType:[''],
    ...
    AddSportsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinner.show();
        ...
        if (this.router.url.includes('add-sports')) {
            ...
            this.AcademicDeptService.getSports(serviceId, termId, termSession).subscribe(function (res) {
                if (res.message == "OK") {
                    _this.mnc = "update";
                    _this.spinner.hide();
                    ...
                    var cmrks = res.object.dRILLSubjectResult;
                    ...
                    _this.drillForm.value.dRILLSubjectResult = [];
                    _this.mnc = "add";
                    // this.isShown = true
                    _this.Campmarks = res.object;
    ...
    AddSportsComponent.prototype.changenew = function (e) {
        var _this = this;
        var frmArray = this.drillForm.get('dRILLSubjectResult');
        frmArray.clear();
        ...
        this.adminservice.getSubjectMarks_List(this.serviceId, this.termId, e).subscribe(function (res) {
            if (res.message == "update") {
                ...
                _this.obtainedmarks = res.object.dRILLSubjectResult;
                ...
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object.dRILLSubjectResult);
                _this.drillForm.patchValue({
                    remarks: res.object.remarks,
                ...
                _this.mnc = "add";
                _this.Campmarks = res.object;
                _this.drillForm.controls['subject'].setValue('');
                _this.drillForm.controls['gcAppt'].setValue('');
                _this.drillForm.controls['remarks'].setValue('');
                _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](res.object);
                _this.cdref.detectChanges();
            }
        }, function (err) {
    ...
    AddSportsComponent.prototype.ngAfterViewInit = function () {
    };
    AddSportsComponent.prototype.getTotal = function () {
        return this.Campmarks.map(function (t) { return t.totalMarks; }).reduce(function (acc, value) { return acc + value; }, 0);
    };
    AddSportsComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\-\ ]/;
    ...
    AddSportsComponent.prototype.viewCamp = function (element) {
    ...
    AddSportsComponent.prototype.onChange = function (value, totalMarks, index) {
    ...
    AddSportsComponent.prototype.onFocusEvent = function (value1) {
    ...
    AddSportsComponent.prototype.getMarks = function (i, e) {
    ...
    AddSportsComponent.prototype.attemptChange = function (e) {
        this.attemptvalue = e;
    };
    AddSportsComponent.prototype.submit = function () {
        var _this = this;
        if (this.drillForm.invalid) {
            ...
            for (var i = 0; i < formdata.dRILLSubjectResult.length; i++) {
                delete formdata.dRILLSubjectResult[i].subjectName;
            }
            console.log(formdata, "finalresult");
            this.AcademicDeptService.addSports(formdata).subscribe(function (res) {
                if (res.message == 'OK') {
                    _this.adminservice.openSnackbar("Drill Marks Added Successfully");
                    // this.spinner.hide()
                }
                (function (err) {
                    // this.spinner.hide()
    ...
    AddSportsComponent.prototype.confirm = function () {
        var _this = this;
        var indexT = 0;
        ...
        this.AcademicDeptService.updateSports(formdata).subscribe(function (res) {
            if (res.message == 'OK') {
    ...
    AddSportsComponent.ctorParameters = function () { return [
    ...
    AddSportsComponent.propDecorators = {
    ...
    AddSportsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-sports',
            template: _raw_loader_add_sports_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_sports_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
        __metadata("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"], app_service_academic_dept_academic_dept_service__WEBPACK_IMPORTED_MODULE_12__["AcademicDeptService"]])
    ], AddSportsComponent);
    return AddSportsComponent;
}());
...
/***/ "XKKg":
/*!*****************************************************************************!*\
  !*** ./src/app/main/academic-depart/sports/add-sports/add-sports.module.ts ***!
  \*****************************************************************************/
/*! exports provided: AddSportsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddSportsModule", function() { return AddSportsModule; });
...
/* harmony import */ var _add_sports_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-sports.component */ "6o4l");
...
var routes = [
    {
        path: '',
        component: _add_sports_component__WEBPACK_IMPORTED_MODULE_8__["AddSportsComponent"]
    }
];
var AddSportsModule = /** @class */ (function () {
    function AddSportsModule() {
    }
    AddSportsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_sports_component__WEBPACK_IMPORTED_MODULE_8__["AddSportsComponent"],
            ],
            imports: [
...
/***/ "llCw":
/*!************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/sports/add-sports/add-sports.component.html ***!
  \************************************************************************************************************************/
