(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-hindi-add-hindi-module"],{

/***/ "7e8O":
/*!******************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/General-Instruction/hindi-cell/add-hindi/add-hindi.component.ts ***!
  \******************************************************************************************************/
/*! exports provided: AddHindiComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddHindiComponent", function() { return AddHindiComponent; });
/* harmony import */ var _raw_loader_add_hindi_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./add-hindi.component.html */ "nder");
/* harmony import */ var _add_hindi_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-hindi.component.scss */ "YHQ+");
...
var AddHindiComponent = /** @class */ (function () {
    function AddHindiComponent(dialog, spinner, route, fb, router, adminservice, cdref, activeRoute) {
        this.dialog = dialog;
    ...
    AddHindiComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    Object.defineProperty(AddHindiComponent.prototype, "f", {
        get: function () {
    ...
    AddHindiComponent.prototype.goBack = function () {
        this.router.navigate(['main/academic-depart/general/hindi']);
    };
    AddHindiComponent.prototype.addExam = function () {
        var _this = this;
        if (this.addPOCForm.invalid || !this.isDoc) {
            ...
            this.adminservice.addClubs(this.addPOCForm.value).subscribe(function (res) {
                ...
                if (res.status == 'OK') {
                    ...
                    _this.spinner.hide();
                    _this.router.navigate(['main/academic-depart/general/hindi']);
                }
                else {
                    _this.spinner.hide();
                    _this.adminservice.openSnackbar(res.message);
    ...
    AddHindiComponent.prototype.charCount = function (e) {
        this.descLength = e.target.value.length;
    };
    AddHindiComponent.prototype.openDoc = function (l) {
        console.log("++++++++", l);
    ...
    AddHindiComponent.prototype.onSelectDoc = function (e) {
    ...
    AddHindiComponent.prototype.updateExam = function () {
        var _this = this;
        this.spinner.show();
    ...
    AddHindiComponent.prototype.apiRes = function (res) {
        if (res.status == 'OK') {
            this.spinner.hide();
    ...
    AddHindiComponent.ctorParameters = function () { return [
    ...
    AddHindiComponent.propDecorators = {
        docFile: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"], args: ['inputFile', { static: true },] }]
    };
    AddHindiComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'ms-add-hindi',
            template: _raw_loader_add_hindi_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_add_hindi_component_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
...
/***/ "YHQ+":
/*!********************************************************************************************************!*\
  !*** ./src/app/main/academic-depart/General-Instruction/hindi-cell/add-hindi/add-hindi.component.scss ***!
  \********************************************************************************************************/
...
/***/ "nder":
/*!**********************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/General-Instruction/hindi-cell/add-hindi/add-hindi.component.html ***!
  \**********************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _add_hindi_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./add-hindi.component */ "7e8O");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _add_hindi_component__WEBPACK_IMPORTED_MODULE_8__["AddHindiComponent"]
    }
];
var AddHindiModule = /** @class */ (function () {
    ...
    AddHindiModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _add_hindi_component__WEBPACK_IMPORTED_MODULE_8__["AddHindiComponent"],
            ],
            imports: [
