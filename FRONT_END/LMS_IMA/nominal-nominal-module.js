(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nominal-nominal-module"],{

/***/ "2P9E":
/*!*************************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/nominal/nominal.component.ts ***!
  \*************************************************************************/
...
/* harmony import */ var _raw_loader_nominal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./nominal.component.html */ "y0LH");
/* harmony import */ var _nominal_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nominal.component.scss */ "MmiQ");
...
var NominalComponent = /** @class */ (function () {
    function NominalComponent(router, adminservice, spinner, cdref, dialog, sharedService) {
        this.router = router;
    ...
    NominalComponent.prototype.getAchievements = function (ACDCLUBS, NOMINAL) {
        var _this = this;
        this.spinner.show();
        this.adminservice.getClubs(ACDCLUBS, NOMINAL, 2).subscribe(function (res) {
            console.log(res);
            if (res.status == "OK") {
    ...
    NominalComponent.prototype.addDay = function () {
    ...
    NominalComponent.prototype.noImg = function (e) {
    ...
    NominalComponent.prototype.viewGC = function (element) {
    ...
    NominalComponent.prototype.changeGCStatus = function (e, d) {
        var _this = this;
        this.spinner.show();
        if (e.checked) {
    ...
    NominalComponent.prototype.delete = function (element) {
        var _this = this;
        this.adminservice.updateClubsStatus(element.id, 3).subscribe(function (res) {
            ...
            if (res.status == 'OK') {
                ...
                _this.cdref.detectChanges();
                _this.spinner.hide();
                _this.router.navigate(['main/academic-depart/clubs/nominal']);
            }
            else {
                _this.spinner.hide();
                _this.adminservice.openSnackbar(res.message);
...
/***/ "BPBt":
/*!**********************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/nominal/nominal.module.ts ***!
  \**********************************************************************/
...
/* harmony import */ var _nominal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nominal.component */ "2P9E");
...
var routes = [
    ...
    {
        path: 'add-nominal',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-nominal-add-nominal-module */ "add-nominal-add-nominal-module").then(__webpack_require__.bind(null, /*! ./add-nominal/add-nominal.module */ "Foy1")).then(function (m) { return m.AddNominalModule; }); }
    },
    {
        path: 'view-nominal',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-nominal-add-nominal-module */ "add-nominal-add-nominal-module").then(__webpack_require__.bind(null, /*! ./add-nominal/add-nominal.module */ "Foy1")).then(function (m) { return m.AddNominalModule; }); }
...
/***/ "MmiQ":
/*!***************************************************************************!*\
  !*** ./src/app/main/academic-depart/clubs/nominal/nominal.component.scss ***!
  \***************************************************************************/
...
/***/ "y0LH":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/main/academic-depart/clubs/nominal/nominal.component.html ***!
  \*****************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
